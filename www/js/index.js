...
{
    var stripeMarkerIcon = new google.maps.MarkerImage(
        "img/stripe_wall.png",
    ...
    var i;
    for (i = 0; i < stripesArray.length; i++) {
        var stripePos = new google.maps.LatLng(stripesArray[i].coord[0], stripesArray[i].coord[1]);
        var stripeMarker = new google.maps.Marker({
            position: stripePos,
            map: map,
            icon: stripeMarkerIcon,
            title: stripesArray[i].name
        });
        markerClickEvent(stripeMarker, stripesArray[i]);
...
var currentPositionMarkerIcon = new google.maps.MarkerImage(
...
var stripesArray = [
    ...
    { name: 'Passe-moi l’ciel (Oh! Sweet Heaven)', artist: 'Stuff et Janry', address: 'Rue des Minimes 96', src: 'img/stripes/passe_moi_le_ciel.jpg', coord: [50.8387322,4.3520306] },
    ...
    { name: 'Bob et Bobette (Spike and Suzy/Willy and Wanda)', artist: 'Vandersteen', address: 'Rue de Laeken', src: 'img/stripes/bob_et_bobette.jpg', coord: [50.85464450813298,4.352259635925293] },
    { name: 'La Vache (The Cow)', artist: 'Johan de Moor', address: 'Hôtel Sleepwell Rue du Damier 23', src: 'img/stripes/la_vache.jpg', coord: [50.8528725,4.357844] },
    ...
    { name: 'Le roi des mouches (Lord of the Flies)', artist: 'Mezzo', address: 'Rue Stiernet', src: 'img/stripes/le_roi_des_mouches.jpg', coord: [50.87640787001476,4.357624053955078] },
